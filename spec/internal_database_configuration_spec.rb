describe ManageIQ::ApplianceConsole::InternalDatabaseConfiguration do
  ...
  it ".postgresql_template" do
    allow(ManageIQ::PostgresAdmin).to receive_messages(:data_directory     => Pathname.new("/var/lib/pgsql/data"))
    allow(ManageIQ::PostgresAdmin).to receive_messages(:template_directory => Pathname.new("/opt/manageiq/manageiq-appliance/TEMPLATE"))
